...
#import "BiddersWebview.h"
#import "BiddersVC.h"
#import <CWStatusBarNotification/CWStatusBarNotification.h>
#import "viplogin.h"
#import "roomFunctionV.h"
#import "beautifulview.h"
#import "JMListen.h"
@interface anchorRoomVC : JMListen
{
    beautifulview *beautifulgirl;//美颜
    viplogin *vipanimation;//坐骑
    SpecialEffect *useraimation;//用户进入动画
    ...
    BiddersWebview *jingpaiweb;
    
    BiddersVC *hostjingpai;//竞拍显示
...
@property(nonatomic,strong)AntPersonMsg *person;//个人信息页
