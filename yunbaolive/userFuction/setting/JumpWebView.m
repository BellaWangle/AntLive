...
-(void)doReturn{
    ...
    NSString *aboutUrl = [h5url stringByAppendingString:@"g=portal&m=page&a=lists"];
    
    NSString *strings = [NSString stringWithFormat:@"g=portal&m=page&a=newslist&uid=%@&version=%@&model=%@",[Config getOwnID],phoneVersion,phoneModel];
