...
@interface MyVideoListVC () <UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"PersonalVideoCell" bundle:nil] forCellWithReuseIdentifier:@"PersonalVideoCell"];
    ...
    _noVideoImage = [[UIImageView alloc] initWithFrame:CGRectMake(_window_width / 3, self.collectionView.center.y - 64 - _window_width / 6, _window_width / 3, _window_width / 3)];
