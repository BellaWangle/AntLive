...
@interface showVideo ()<UIActionSheetDelegate,UITextFieldDelegate,WMPlayerDelegate>//
{
...
-(void)getnewreload{
 ...
 //点亮
-(void)setliaght{
    UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(antLiteStarlight)];
...
- (IBAction)morebtn:(id)sender {
    if (!videomore) {
         __weak showVideo *weakself = self;
