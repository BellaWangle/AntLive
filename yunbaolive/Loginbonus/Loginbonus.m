...
#import "Loginbonus.h"
#import "LoginbonusCell.h"
#import "LoginbonusCell2.h"
...
{
    CADisplayLink *_link;
    LoginbonusCell *selectCell;
    LoginbonusCell2 *selectCell2;
...
-(UICollectionViewCell*)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row  == 6) {
        LoginbonusCell2 *cell2 = [collectionView dequeueReusableCellWithReuseIdentifier:IDENTIFIER2 forIndexPath:indexPath];
        ...
        LoginbonusCell *cell1 = [collectionView dequeueReusableCellWithReuseIdentifier:IDENTIFIER forIndexPath:indexPath];
