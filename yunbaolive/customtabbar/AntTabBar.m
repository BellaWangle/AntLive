...
#define ZYMagin 30
@interface AntTabBar ()<MXtabbarDelegate>
@end
@implementation AntTabBar
//对按钮的一些基本设置
...
- (void)drawRect:(CGRect)rect {
    if (!self.plusBtn) {
        ...
        self.plusBtn = [[MXtabbar alloc]initWithCenterImage:[UIImage imageNamed:@"tabbar_center"]highlightedImage:[UIImage imageNamed:@"tabbar_center"]];
        self.plusBtn.delegate = self;
        [self setUpPathButton:self.plusBtn];
        //必须加到父视图上
        
        UIImageView * imageView = [[UIImageView alloc]init];
        imageView.image = [UIImage imageNamed:@"tabbar_center_bg"];
        imageView.frame = CGRectMake(self.centerX-70, self.top-25, 140, 25);
