...
#import "AntNearVC.h"
#import "AntLiveRankVC.h"
#import "LiveOrDynamicView.h"
#import "VideoRecordViewController.h"

@interface AntTabBarController ()<ZYTabBarDelegate,UIAlertViewDelegate>
{
...
- (void)setMXtabbar {
    AntTabBar *tabbar = [AntTabBar new];
...
- (void)setTabbarController {
    ...
    homeCustom *home = [[homeCustom alloc]init];
    
    AntNearVC *near = [[AntNearVC alloc]init];
    
    AntLiveRankVC *rank = [[AntLiveRankVC alloc]init];
    
    AntUserInfoViewController *userInfo = [AntUserInfoViewController new];
    
    [self setUpOneChildVcWithVc:home Image:@"tab_home" selectedImage:@"tab_home_sel" title:nil];
    [self setUpOneChildVcWithVc:near Image:@"tab_near" selectedImage:@"tab_near_sel" title:nil];
    [self setUpOneChildVcWithVc:rank Image:@"tab_rank" selectedImage:@"tab_rank_sel" title:nil];
