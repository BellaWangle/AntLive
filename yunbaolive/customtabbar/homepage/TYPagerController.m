...
-(void)setContentFrame{
    [_contentView setContentOffset:CGPointMake(_window_width*2,0) animated:NO];
    
    
}
- (void)reSizeContentView
{
    CGFloat contentTopEdging = _contentTopEdging + [self statusBarHeight] + statusbarHeight;
    ...
    _contentView.contentOffset = CGPointMake(CGRectGetWidth(_contentView.frame)*2, 0);
