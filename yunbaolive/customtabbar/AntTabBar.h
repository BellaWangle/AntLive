...
@required
- (void)pathButton:(AntTabBar *)ZYTabBar clickItemButtonAtIndex:(NSUInteger)itemButtonIndex;
@end

@interface AntTabBar : UITabBar
/** 点中button代理属性 */
@property (nonatomic , weak)id<ZYTabBarDelegate> delegate;

/** 所有的弹出按钮 */
@property (nonatomic , strong)NSArray<AntPathItemButton *> *pathButtonArray;
