...
@interface eidtIcon ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate>
{
    NSString  *filePath;
    NSURL *imageURL;
    int setvisicon;
...
- (void)viewDidLoad {
    ...
    [self.paizhaob setTitle:YZMsg(@"拍照") forState:0];
    self.xiangceb.layer.masksToBounds = YES;
    self.xiangceb.layer.cornerRadius = 15;
    [self.xiangceb setTitle:YZMsg(@"相册") forState:0];
}
