...
- (void)initUI
{
    ...
    _prgRecordedProgress.progressTintColor = UIColorFromRGB(0x0ACCAC);
    
    _vRecordedDurationTips = [[UILabel alloc] init];
    _vRecordedDurationTips.backgroundColor = UIColorFromRGB(0x0ACCAC);
...
//        [HUDHelper alert:kErrorMsgLiveStopped cancel:YZMsg(@"确认") action:^{
//            [self  closeRecord];
//        }];
//    }
//}
