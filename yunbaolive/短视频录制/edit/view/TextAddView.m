...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        [_textAddButton setTitle:YZMsg(@"添加普通字幕/气泡字幕") forState:UIControlStateNormal];
...
- (void)setEdited:(BOOL)isEdited
{
    if (!isEdited) {
        ...
        [_textAddButton setTitle:YZMsg(@"编辑普通字幕/气泡字幕") forState:UIControlStateNormal];
    }
}
