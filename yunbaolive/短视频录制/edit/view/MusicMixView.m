...
@implementation MusicMixView
{
    ...
    NSString*   _selectedFilePath;          //选取的音乐文件
...
- (void)loadAllMusics
{
    ...
    //本地原有的mp3
//    NSArray *noArray = @[[[NSBundle mainBundle] pathForResource:@"DefaultBGM_2" ofType:@"mp3"],[[NSBundle mainBundle] pathForResource:@"buttonclickaaaaa" ofType:@"mp3"],[[NSBundle mainBundle] pathForResource:@"beginguesssound" ofType:@"mp3"],[[NSBundle mainBundle] pathForResource:@"guesssuccesssound" ofType:@"mp3"]];
//
...
//            NSURL *url = [NSURL fileURLWithPath:[NSString stringWithFormat:@"%@/%@",docDir,str]];
...
//        if ([noArray containsObject: filePath]) {
//            continue;
//        }
//        NSURL *url = [NSURL fileURLWithPath:filePath];
//        AVURLAsset *musicAsset = [AVURLAsset URLAssetWithURL:url options:nil];
...
- (UICollectionViewCell*)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == _allMusicArray.count) {
        ...
        cell.songNameLabel.text = YZMsg(@"本地音频");
