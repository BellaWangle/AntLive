...
-(void)userPlar:(NSDictionary *)dic{
    ...
    _label = [[YFRollingLabel alloc] initWithFrame:CGRectMake(0,_window_width*0.4,_window_width,20)  textArray:textArray font:[UIFont systemFontOfSize:12] textColor:normalColors];
    ...
    //car_words
    _isUserMove = 1;
    _userMoveImageV = [[UIImageView alloc]initWithFrame:CGRectMake(0,0,_window_width,_window_width*0.4)];
    [_userMoveImageV sd_setImageWithURL:[NSURL URLWithString:minstr([[dic valueForKey:@"ct"] valueForKey:@"car_swf"])]];
