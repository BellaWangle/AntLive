...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        self.downBTN.frame = CGRectMake(_window_width - 70,10,50,50);
        self.downBTN.layer.masksToBounds = YES;
        self.downBTN.layer.cornerRadius = 25;
...
-(void)musicDownLoad{
    ...
    if (![manager fileExistsAtPath:loadPath]) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"changemusicaaaaa" object:nil userInfo:dic];
