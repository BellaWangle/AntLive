...
//    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"navi_back"]];
//    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"navi_back"] forBarMetrics:UIBarMetricsDefault];
    ...
    UIBarButtonItem *customBackButton = [[UIBarButtonItem alloc] initWithTitle:YZMsg(@"返回")
