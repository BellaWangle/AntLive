...
- (NSMutableArray *)effectArray
{
    if(!_effectArray){
        ...
        [_effectArray addObject:YZMsg(@"清除")];
        [_effectArray addObject:YZMsg(@"美白")];
        [_effectArray addObject:YZMsg(@"浪漫")];
        [_effectArray addObject:YZMsg(@"清新")];
        [_effectArray addObject:YZMsg(@"唯美")];
        [_effectArray addObject:YZMsg(@"粉嫩")];
        [_effectArray addObject:YZMsg(@"怀旧")];
        [_effectArray addObject:YZMsg(@"蓝调")];
        [_effectArray addObject:YZMsg(@"清亮")];
        [_effectArray addObject:YZMsg(@"日系")];
    }
    return _effectArray;
}
...
- (NSMutableArray *)greenArray
{
    if(!_greenArray){
        ...
        [_greenArray addObject:YZMsg(@"清除")];
...
- (NSMutableArray *)beautyArray
{
    if(!_beautyArray){
        ...
        [_beautyArray addObject:YZMsg(@"美颜")];
        [_beautyArray addObject:YZMsg(@"美白")];
        [_beautyArray addObject:YZMsg(@"红润")];
...
- (NSMutableArray *)beautyTypeArray
{
    if(!_beautyTypeArray){
        ...
        [_beautyTypeArray addObject:YZMsg(@"光滑")];
        [_beautyTypeArray addObject:YZMsg(@"自然")];
        [_beautyTypeArray addObject:YZMsg(@"P图")];
    }
...
//        [_functionArray addObject:@"原图"];
        [_functionArray addObject:YZMsg(@"风格")];
        [_functionArray addObject:YZMsg(@"美颜")];
        [_functionArray addObject:YZMsg(@"滤镜")];
