...
@property (weak, nonatomic) IBOutlet UILabel *todayKeLabel;
@property (weak, nonatomic) IBOutlet UIButton *wentiBtn;
...
[super viewDidLoad];
    ...
    [_wentiBtn setTitle:YZMsg(@"常见问题") forState:0];
...
- (IBAction)DoQuestion:(id)sender {
    ...
    NSString *strings = [NSString stringWithFormat:@"g=portal&m=page&a=newslist&uid=%@&version=%@&model=%@&token=%@",[Config getOwnID],phoneVersion,phoneModel,[Config getOwnToken]];
