...
- (void)viewDidLoad {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"fujincell" bundle:nil] forCellWithReuseIdentifier:@"fujincell"];
...
-(void)pullInternetforNew{
    ...
    NSString *postUrl = [purl stringByAppendingFormat:@"service=Home.getNearby&lng=%@&lat=%@&city=%@",[cityDefault getMylng],[cityDefault getMylat],[cityDefault getMyCity]];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    fujincell *cell = (fujincell *)[collectionView dequeueReusableCellWithReuseIdentifier:@"fujincell" forIndexPath:indexPath];
