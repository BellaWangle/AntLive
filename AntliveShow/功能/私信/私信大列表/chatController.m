...
-(void)pushMessage{
     ...
     NSString *userBaseUrl = [purl stringByAppendingFormat:@"service=User.checkBlack&uid=%@&touid=%@",[Config getOwnID],self.chatID];
...
-(void)navtion{
    ...
    returnBtn.frame = CGRectMake(10,30+statusbarHeight,30,20);
    returnBtn.tintColor = [UIColor blackColor];
    [returnBtn.imageView setContentMode:UIViewContentModeScaleAspectFit];
