...
-(void)loadrequest:(NSString *)stream{
    ...
    userBaseUrl =[h5url stringByAppendingFormat:@"g=Appapi&m=Auction&a=index&uid=%@&token=%@&addr=%@&stream=%@",[Config getOwnID],[Config getOwnToken],[cityDefault getaddr],stream];
