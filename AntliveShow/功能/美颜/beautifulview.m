...
-(instancetype)initWithFrame:(CGRect)frame andhide:(minxinblock)hide andslider:(minxinblock)slider andtype:(minxinblock)type{
    ...
    if (self) {
           ...
           self.typeblocks = type;
            ...
            [meiyanbtn1 setTitle:[NSString stringWithFormat:@"%@(√)",YZMsg(@"原始美白")] forState:UIControlStateSelected];
            ...
            [meiyanbtn2 setTitle:[NSString stringWithFormat:@"%@(√)",YZMsg(@"美颜")] forState:UIControlStateSelected];
            ...
            [meiyanbtn3 setTitle:[NSString stringWithFormat:@"%@(√)",YZMsg(@"白皙")] forState:UIControlStateSelected];
            
            
            meiyanbtn4 = [[UIButton alloc] initWithFrame:CGRectMake(20, 45 *3 , _window_width-40, 40)];
            [meiyanbtn4 setTitle:[NSString stringWithFormat:@"%@+",YZMsg(@"美颜")] forState:UIControlStateNormal];
            [meiyanbtn4 setTitle:[NSString stringWithFormat:@"%@+(√)",YZMsg(@"美颜")] forState:UIControlStateSelected];
            ...
            [meiyanbtn5 setTitle:[NSString stringWithFormat:@"%@+(√)",YZMsg(@"不使用美颜")] forState:UIControlStateSelected];
