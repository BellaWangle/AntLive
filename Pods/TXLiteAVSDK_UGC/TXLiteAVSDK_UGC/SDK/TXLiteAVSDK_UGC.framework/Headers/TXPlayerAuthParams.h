...
@property int appId;        ///应用appId。必填
@property NSString *fileId; ///文件id。必填
@property NSString *timeout;///加密链接超时时间戳，转换为16进制小写字符串，腾讯云 CDN 服务器会根据该时间判断该链接是否有效。可选
@property int exper;        ///试看时长，单位：秒。可选
@property NSString *us;     ///唯一标识请求，增加链接唯一性
/**
 无防盗链不填
...
@property BOOL https;       ///是否用https请求，默认NO
@end
